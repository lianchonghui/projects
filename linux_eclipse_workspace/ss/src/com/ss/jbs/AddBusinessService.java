...
public class AddBusinessService extends com.siebel.eai.SiebelBusinessService {
	...
	SiebelPropertySet output) throws SiebelBusinessServiceException {
		...
		String param = input.getProperty("param");
		
		if (url == null || url.equals("") || (param == null) || param.equals("")) {
		...
		if (!methodName.equals ("Post")) {
	        ...
	        try {
	            ...
	            result = sessionId[0];
	            output.setProperty("session", result);
	        } catch (Exception e) {
	            //System.out.println("发送 POST 请求出现异常！"+e);
	        	e.printStackTrace();
	        	throw new SiebelBusinessServiceException("POST_REQUEST_ERROR", e.getMessage());
	        }
